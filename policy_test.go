...
func TestNewCasbinPolicy(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.want != got {
				t.Errorf("newCasbinPolicy() mismatch")
			}
		})
	}
}

func TestCasbinPolicyToSlice(t *testing.T) {
	type fields struct {
		ptype string
		v0    string
		v1    string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !slices.Equal(tt.want, policy.toSlice()) {
				t.Errorf("toSlice() mismatch")
			}
		})
	}
}
...
func TestCasbinPolicy_filterValues(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !slices.Equal(tt.want, policy.filterValues()) {
				t.Errorf("filterValues() mismatch")
			}
		})
	}
}
...
func TestCasbinPolicy_filterValuesWithKey(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !maps.Equal(tt.want, policy.filterValuesWithKey()) {
				t.Errorf("filterValuesWithKey() mismatch")
			}
		})
	}
}
